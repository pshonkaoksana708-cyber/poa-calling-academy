...
const supplyPageCopy = {
  ...
  heroDescription:
    "Освойте профессию специалиста по снабжению с нуля и научитесь работать с заявками, поставщиками, закупками, документами и поставками.",
  heroOutcome:
...
const hrPageCopy = {
  ...
  heroDescription:
    "Научитесь находить сотрудников, проводить собеседования, адаптировать персонал и выстраивать работу с людьми — даже если раньше вы не работали в HR.",
  heroOutcome:
...
const aiPageCopy = {
  ...
  heroOutcome:
    "Практический курс по нейросетям помогает разобраться в AI-инструментах без сложного программирования и технической перегрузки.",
  audienceIntro:
